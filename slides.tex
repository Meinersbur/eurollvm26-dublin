...
\begin{itemize}
\item[\pgfuseimage{file}] \shinline{dublin/test/Unit/lit.cfg.py}, \shinline{dublin/test/Unit/lit.site.cfg.py.in}
    \begin{itemize}
    \item \shinline{llvm-lit} configuration
      \begin{itemize}
      ...
      \end{itemize}
    \end{itemize}
\item[\pgfuseimage{file}] \shinline{dublin/unittests/CMakeLists.txt}
    \begin{itemize}
    \item Unittest (Google Test-based) executable build instructions
    \end{itemize}
\end{itemize}a
\end{frame}
